...
flights_df.write.saveAsTable("sgr_us_delay_flights_tbl")
ORD_DF = spark.sql("SELECT date, delay, origin, destination FROM sgr_us_delay_flights_tbl  WHERE origin = 'ORD'")
#ORD_DF.show(5)
ORD_DF.createOrReplaceTempView("view_ord_sgr_us_delay_flights_tbl").show(10)
