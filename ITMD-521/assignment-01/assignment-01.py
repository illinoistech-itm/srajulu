...
## Inferring Schema
    ...
    parquet_path = infer_divvy_df.write.format("parquet").save("../assignment-01/example-data/divy-2015.parquet")
    parquet_file = spark.read.format("parquet").load("../assignment-01/example-data/divy-2015.parquet")
